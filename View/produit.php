            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-1 rounded js-scroll-trigger" href="#">Produit</a></li>
                        ...
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-1 rounded js-scroll-trigger" href="AfficherSuivis.php">Suivis</a></li>
...
<!--
<center><input type="text" id="myInput" onkeyup="myFunction()" placeholder="Chercher un titre.." title="Type in a name"></center>
<br></br>
-->
			...
			?>
				<tr>
					...
					<td><?PHP echo '<img src="../Backend/now-ui-dashboard-master/assets/img/'.$Prod['image'].'" style="width: 100px;" >'; ?></td>
					<td><?PHP echo $Prod['titre']; ?></td>
					<td><?PHP echo $Prod['description']; ?></td>
					<td>
					
					<!-- HEDHEYA BICH NAJEM NHOT FEL PANIER
					<form method="POST" action="ajouterproduitaupanier.php"> 
					<input type="hidden" name="idproduit" value="<?php echo $row['Id'] ?>">
					-->
					<!--------------------------------------PANIER_NOUR------------------------------------>
            <div><a href="PRODUITCOMMANDER.php?produit=<?PHP echo $Prod['idProduit']; ?>"> <button type="button" >Ajouter au panier</button></a></div>
					<!--------------------------------------PANIER_NOUR------------------------------------>
					...
					<!--
					<td><a href="modifierProd.php?idProduit=<?PHP echo $Prod['idProduit']; ?>"> Modifier </a></td>
					-->
